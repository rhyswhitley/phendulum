...
def main():
    ...
    raw_data = dh.import_data(DATAPATH)
    ...
    post_table = pd.read_csv(SPRING_POST)
...
def _plotSpring(ax, data, k_means, k_05, k_95, site_name, xlabel="SWC10"):
    ...
    ax.plot_date(data.index[::16], data["NDVI_norm"][::16], 'o', linestyle='-', lw=1.2, \
...
if __name__ == "__main__":
    ...
    SPRING_POST = "../outputs/pars/spring_posteriors.csv"
    DATAPATH = "../data/"
    main()
